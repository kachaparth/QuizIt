...
for (const bot of bots) {
  test(`Automated Bot: ${bot.email}`, async ({ page }) => {
    // ==========================================
    ...
    await page.waitForTimeout(Math.random() * 7000);
    ...
    for (let i = 0; i < totalQuestions; i++) {
      ...
      // Simulate thinking time (5-7 seconds)
      const thinkingTime = 5000 + Math.floor(Math.random() * 2001);
